...
class EvalProdCont {
    ...
    guardarResultadoEval(req, res) {
        ...
        evaluacion
            ...
            .then(
                res.status(200).json({ message: "Resultado de la evaluación registrada con éxito" })
            )
            .catch((e) => {
    ...
    getEscalas(req, res) {
        ...
        evaluacion
            ...
            .then(function (escalas) {
                res.status(200).json({ Info_de_Evaluacion: escalas });
            })
    ...
    */
        ...
        evaluacion
            ...
            .then(() => {
                res.status(200).json({ message: "Evaluación de criterios creada con éxito" });
            })
            .catch((e) => {
                console.error(e.stack);
    ...
    //Información de evaluación de criterios (renovacion)
    getEvalCritRenov(req, res) {
        ...
        evaluacion
            ...
            .then(function (evalua) {
                res.status(200).json({ Info_de_Evaluacion_renov: evalua });
            })
            .catch((e) => console.error(e.stack));
    }
